...
<head>
  ...
  <style>
    ...
    .payment-link { font-size: 0.875rem; font-weight: 500; color: ${secondary}; margin-top: 4px; word-break: break-all; }
...
<body>
  ...
  <div class="signature-section">
    <div>
      ${invoice.sellerSignatureData ? `<img src="${invoice.sellerSignatureData.replace(/"/g, "&quot;")}" alt="" class="signature-img" />` : "<div class=\"signature-line\"></div>"}
